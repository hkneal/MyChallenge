...
def create_address(payload, person_id):
    ...
    # ahead and create with no additional logic.
        ...
        current_start_dates = [person.start_date for person in person.address_segments]
        if payload.get("start_date") in current_start_dates:
            abort(404, description="start date already in addresses")
